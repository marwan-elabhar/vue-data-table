...
<template>
  <div class="min-w-100 row-border d-inline-block" :style="{ backgroundColor: rowBGColor }">
    <div class="d-flex align-items-center w-100 row-container">
      <div class="w-100">
        <div
          class="d-flex w-100 align-items-center p-x-18"
          :class="[
        ...
        >
          ...
          <div
            class="p-y-15 d-flex align-items-center gap-6"
            :class="{
          ...
          >
            ...
            <div class="d-flex align-items-center w-100">
              <component
                :is="types[firstCell.dataType] || firstCell.component"
                v-if="Object.keys(types).includes(firstCell.dataType)"
                :cell="firstCell"
                :record="record"
                :options="options"
          ...
          <div
            class="p-y-15 d-flex align-items-center"
            :class="{
          ...
          >
            <div class="d-flex align-items-center w-100">
              <template v-if="!lastCell.hasPositionedContent">
                <component
                  :is="types[lastCell.dataType] || lastCell.component"
                  v-if="Object.keys(types).includes(lastCell.dataType)"
                  :cell="lastCell"
                  :record="record"
                  :options="options"
                  @entity-clicked="entityClicked"
